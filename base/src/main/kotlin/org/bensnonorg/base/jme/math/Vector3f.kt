...
operator fun Vector3f.minusAssign(it: Vector3f) { this.subtractLocal(it) }
operator fun Vector3f.plusAssign(it: Vector3f) { this.addLocal(it) }
operator fun Vector3f.timesAssign(it: Float) { this.multLocal(it) }
operator fun Vector3f.divAssign(it: Float) { this.multLocal(1 / it) }
